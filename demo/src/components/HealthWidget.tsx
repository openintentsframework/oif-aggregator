  ...
  return (
    ...
    >
      ...
      >
        <div className="flex items-center gap-2">
          <div
            className={`w-2 h-2 rounded-full ${getStatusColor(health.status)} animate-pulse`}
          ></div>
          <span
            className={`text-xs font-medium ${getStatusTextColor(health.status)}`}
          >
            {health.status.toUpperCase()}
          </span>
          <span className="text-slate-400 dark:text-slate-500 text-xs">•</span>
          <span className="text-slate-600 dark:text-slate-400 text-xs">
            {health.solvers.active}/{health.solvers.total} solvers
          </span>
        </div>
            ...
            <div className="pt-2 border-t border-slate-200 dark:border-slate-700">
              ...
              <div className="space-y-1">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span
                    className={`text-xs ${health.storage.healthy ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}
                  >
