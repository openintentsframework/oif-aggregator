...
impl AdapterStatusStorage {
    ...
    fn to_domain(&self) -> AdapterStatus {
        match self {
            ...
            Self::Initializing => AdapterStatus::Initializing,
            Self::Maintenance => AdapterStatus::Maintenance,
...
impl AdapterTypeStorage {
    fn from_domain(adapter_type: &AdapterType) -> Self {
        match adapter_type {
            ...
            AdapterType::UniswapV2 => Self::UniswapV2,
            AdapterType::UniswapV3 => Self::UniswapV3,
            AdapterType::OneInch => Self::OneInch,
            AdapterType::Paraswap => Self::Paraswap,
            AdapterType::Lifi => Self::Lifi,
            AdapterType::Cowswap => Self::Cowswap,
            AdapterType::ZeroX => Self::ZeroX,
            AdapterType::Kyber => Self::Kyber,
            AdapterType::SushiSwap => Self::SushiSwap,
            AdapterType::Balancer => Self::Balancer,
            AdapterType::Curve => Self::Curve,
            AdapterType::Custom => Self::Custom,
        }
    }
    ...
    fn to_domain(&self) -> AdapterType {
        match self {
            ...
            Self::UniswapV2 => AdapterType::UniswapV2,
            Self::UniswapV3 => AdapterType::UniswapV3,
            Self::OneInch => AdapterType::OneInch,
            Self::Paraswap => AdapterType::Paraswap,
            Self::Lifi => AdapterType::Lifi,
            Self::Cowswap => AdapterType::Cowswap,
            Self::ZeroX => AdapterType::ZeroX,
            Self::Kyber => AdapterType::Kyber,
            Self::SushiSwap => AdapterType::SushiSwap,
            Self::Balancer => AdapterType::Balancer,
            Self::Curve => AdapterType::Curve,
            Self::Custom => AdapterType::Custom,
        }
    }
}
...
impl AdapterCapabilityStorage {
    ...
    fn to_domain(self) -> AdapterResult<AdapterCapability> {
...
impl AdapterMetricsStorage {
    ...
    fn to_domain(self) -> AdapterResult<AdapterMetrics> {
        Ok(AdapterMetrics {
            performance: self.performance.to_domain(),
...
impl AdapterPerformanceStorage {
    ...
    fn to_domain(self) -> AdapterPerformanceMetrics {
...
impl AdapterHealthStorage {
    ...
    fn to_domain(self) -> AdapterResult<AdapterHealthResult> {
...
mod tests {
    use super::*;
    use crate::models::adapters::{Adapter, AdapterType};
