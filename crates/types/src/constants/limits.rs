...
pub const MAX_GLOBAL_TIMEOUT_MS: u64 = 120_000; // 2 minutes
...
/// Default per-solver timeout in milliseconds (used when solver_timeout not specified)
pub const DEFAULT_PER_SOLVER_TIMEOUT_MS: u64 = 2_500; // 2.5s
